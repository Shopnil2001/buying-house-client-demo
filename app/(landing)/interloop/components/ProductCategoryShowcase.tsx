...
export default function ProductCategoryShowcase() {
  ...
  return (
    <section id="our-products" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#090E17] border-t border-white/10 text-stone-100">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-cyan-500/30 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center bg-[#0C1524]">
          {/* Left Column (Specs & Desc) */}
          ...
          {/* Right Column (Capacity & Lead Time Highlights) */}

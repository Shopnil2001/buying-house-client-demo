...
import InterloopCinematicReveal from "./components/InterloopCinematicReveal";
import ScrollFabricSimulation from "./components/ScrollFabricSimulation";
...
export default function InterloopLandingPage() {
  ...
  return (
    <div className="bg-[#050912] text-stone-100 min-h-screen relative selection:bg-cyan-500/30 selection:text-cyan-200">
      ...
      <InterloopCinematicReveal key={revealKey} />

      {/* 2. Continuous Scroll-Driven Physics Fabric Ribbon Simulation */}
      <ScrollFabricSimulation />
      ...
      <button
        ...
        title="Replay Cinematic Silk Intro"
      >
      ...
      <section className="relative min-h-[95vh] flex items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 py-20">
        <div className="relative z-20 max-w-5xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-950/80 border border-cyan-500/40 text-cyan-300 text-xs font-mono uppercase tracking-widest backdrop-blur-md shadow-2xl">
            ...
            <span>Enterprise Textile & Apparel Sourcing Powerhouse</span>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-950/60 border border-cyan-500/30 text-cyan-300 text-xs font-mono uppercase tracking-wider">
              ...
              <span>Corporate Heritage & Bangladesh Presence</span>
            </div>
            ...
            <p className="text-stone-300 leading-relaxed text-sm sm:text-base">
              With major industrial manufacturing campuses strategically situated in <strong>Soydana, Gazipur</strong> and the <strong>Dhaka industrial corridor</strong>, our operations combine four decades of engineering expertise with Bangladesh's strategic duty-free export advantages.
            </p>
      ...
      {/* SECTION 6: OUR PHILOSOPHY & FABRIC RIBBON TEXT REVEAL */}
      <section 
        id="fabric-philosophy-section" 
        className="py-36 px-4 sm:px-6 lg:px-8 border-t border-white/10 relative overflow-hidden bg-gradient-to-b from-[#080E18] via-[#050A12] to-[#080E18]"
      >
        <div className="max-w-5xl mx-auto text-center space-y-10 relative z-20">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-black uppercase text-white font-sans tracking-tight">
              People • Planet • Prosperity
            </h2>
            <p className="text-sm sm:text-lg text-stone-300 max-w-2xl mx-auto font-light leading-relaxed">
              As the floating fabric ribbon weaves across the screen, our commitment remains woven into every thread: empowering workers, protecting nature, and driving sustainable commercial success.
            </p>
          </div>

          {/* 3 Pillars Card Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-6 text-left">
            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/15 space-y-3 bg-[#0B1526]/85 backdrop-blur-xl shadow-2xl">
              <span className="text-xs font-mono text-cyan-400 font-bold uppercase block">Pillar 01</span>
              <h3 className="text-xl font-bold text-white">People First</h3>
              <p className="text-xs text-stone-300 leading-relaxed">
                Fair living wages, onsite subsidized healthcare, daycare facilities, and professional development programs across all production facilities.
              </p>
            </div>

            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-emerald-500/30 space-y-3 bg-[#0B1D14]/85 backdrop-blur-xl shadow-2xl">
              <span className="text-xs font-mono text-emerald-400 font-bold uppercase block">Pillar 02</span>
              <h3 className="text-xl font-bold text-white">Planet Preservation</h3>
              <p className="text-xs text-stone-300 leading-relaxed">
                15.8 MW solar power, closed-loop water recycling, and 100% GOTS organic traceable cotton reducing chemical loads to zero.
              </p>
            </div>

            <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-amber-500/30 space-y-3 bg-[#1A150D]/85 backdrop-blur-xl shadow-2xl">
              <span className="text-xs font-mono text-amber-400 font-bold uppercase block">Pillar 03</span>
              <h3 className="text-xl font-bold text-white">Shared Prosperity</h3>
              <p className="text-xs text-stone-300 leading-relaxed">
                Reliable long-term partnership with global retailers, ethical pricing transparency, and continuous technological modernization.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="glass-panel p-6 sm:p-8 rounded-3xl border border-white/10 space-y-6 bg-[#0A1424]">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-stone-400 font-mono">
                    Interloop Bangladesh Manufacturing Operations
                  </p>
                </div>
                ...
                <div className="space-y-4 text-xs font-mono text-stone-300">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-cyan-300">sourcing@interloopbd.com</span>
                  </div>
                </div>
              </div>
            </div>

            {/* Interactive Inquiry Form (Right 7 Cols) */}
              ...
              {contactSubmitted ? (
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                  ...
                  >
                    ...
                    <span>Dispatch Inquiry to Interloop BD Desk</span>
                  </button>
                </form>
              )}
            </div>
      ...
      <footer className="py-16 px-4 sm:px-6 lg:px-8 border-t border-white/10 bg-black/90 text-stone-400 text-xs font-mono">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="space-y-1 text-center sm:text-left">
            <div className="font-bold text-white text-sm">INTERLOOP BANGLADESH LTD — ENTERPRISE APPAREL POWERHOUSE</div>

...
export default function FactsFigures() {
  return (
    <section id="key-facts" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#060A12] border-t border-white/10 text-stone-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {FACTS.map((f, i) => {
            ...
            return (
              <div
                key={i}
                className="p-6 sm:p-8 rounded-3xl bg-[#0B1320] border border-white/10 hover:border-cyan-500/40 transition-all duration-300 space-y-4 hover:shadow-xl hover:shadow-cyan-950/40"
              >

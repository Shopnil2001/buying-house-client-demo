  ...
  return (
    <SmoothScrollProvider>
      <div className="bg-[#080E17] text-[#FAF7F2] min-h-screen relative selection:bg-[#C26747]/30 selection:text-amber-200 overflow-x-hidden">
        ...
        {/* SECTION 3: ABOUT US (With Interactive Loom Weaving 3D Grid) */}
        <SectionTransitionWrapper id="about-us" variant="zoom-depth" className="py-28 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="p-5 rounded-2xl border border-white/10 bg-[#0E1624]/90 backdrop-blur-md shadow-xl space-y-2.5">
        ...
        <SectionTransitionWrapper id="trusted-customers" variant="silk-reveal" className="py-28 px-4 sm:px-6 lg:px-8 bg-[#080E17]/90 backdrop-blur-sm">
        ...
        <SectionTransitionWrapper id="contact-us" variant="zoom-depth" className="py-28 px-4 sm:px-6 lg:px-8 bg-[#080E17]/90 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto space-y-12">
            <div className="text-center max-w-3xl mx-auto space-y-4">
